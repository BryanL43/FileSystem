...
typedef struct
	...
	unsigned short  d_reclen;			/* length of this record (block amount) */
	unsigned short	dirEntryPosition;	/* which directory entry position, like file pos */
	unsigned long	dirEntryLocation;	/* location of the first directory entry */
	unsigned int	index;				/* index of the current directory */
...
int fs_move(char *srcPathName, char* destPathName); // move directories and files
